---
description: Bootstrap a new Hive (hexagonal) project and verify it builds
argument-hint: "[basePackage]"
---

You are bootstrapping a new **Hive** hexagonal-architecture Java project in the current directory, using the `hive` CLI. Be fast and deterministic: let the CLI create the structure, don't hand-write it.
